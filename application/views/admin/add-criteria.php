			...
			<div class="container cont-main-frame">
				...
				<div class="main-box">
					...
					<div class="header-title">
						<h1 class="main-title">Tambah Kriteria</h1>
						<hr class="title-line">
					</div>
					<!-- akhir header title -->
				</div>
				<div class="card bg-main-card">
					<div class="card-header card-header-custom">
						Form <strong>Tambah Kriteria</strong>
					</div>
					...
					<div class="card-body">
						<form method="POST" action="" class="form-custom">
							...
							<div class="form-group row">
								...
								<div class="col-sm-10">
									<select class="custom-select select-custom dropdown-success" name="bobot">
										...
										<option class="option-custom" value="1">Sangat tidak penting</option>
										<option class="option-custom" value="2">Tidak penting</option>
										<option class="option-custom" value="3">Cukup penting</option>
										<option class="option-custom" value="4">Penting</option>
										<option class="option-custom" value="5">Sangat penting</option>
									</select>
							...
							<div class="form-group" style="float: right;">
								...
								<a href="<?= base_url('admin/criteria'); ?>"><button type="button" class="btn btn-danger ml-4"><i class="fas fa-undo"></i>&nbsp; Batal</button></a>
							</div>
						</form>
					</div>
				</div>
