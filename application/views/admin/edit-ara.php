			...
			<div class="container cont-main-frame">
				...
				<div class="main-box">
					...
					<div class="header-title">
						<h1 class="main-title">Ubah Varietas Ara</h1>
						<hr class="title-line">
					</div>
					<!-- akhir header title -->
				</div>
				<div class="card bg-main-card">
					<div class="card-header card-header-custom">
						Form <strong>Ubah Data</strong> Alternatif
					</div>
					...
					<div class="card-body">
						<form method="POST" action="" class="form-custom">
							<div class="form-group row">
								...
								<div class="col-sm-10">
									<input type="text" readonly class="form-control-plaintext" id="kode" name="kode" value="<?= $ara['kode']; ?>">
								</div>
							</div>
							<div class="form-group row">
								<label class="col-sm-2 col-form-label">Nama Alternatif</label>
								<div class="col-sm-10">
									<input type="text" class="form-control input-custom" id="nama" name="nama" autocomplete="off" value="<?= $ara['nama']; ?>">
									<?= form_error('nama', '<small class="text-danger">', '</small>'); ?>
								</div>
							</div>
							<div class="form-group" style="float: right;">
								<button type="submit" class="btn btn-primary btn-md"><i class="far fa-save"></i>&nbsp; Simpan</button>
								<a href="<?= base_url('admin/ara'); ?>"><button type="button" class="btn btn-md btn-danger"><i class="fas fa-undo"></i>&nbsp; Batal</button></a>
							</div>
						</form>
					</div>
				</div>
