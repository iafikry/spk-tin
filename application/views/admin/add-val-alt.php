		<div class="collapse navbar-collapse" id="navbarNavAltMarkup">
			<div class="navbar-nav ml-auto">
				<a class="nav-item nav-link" id="nav-home" href="<?= base_url('admin'); ?>">beranda</a>
				<a class="nav-item nav-link" id="nav-pengguna" href="<?= base_url('admin/pengguna'); ?>">pengguna</a>
			...
			<div class="container cont-main-frame">
				...
				<div class="main-box">
					...
					<div class="header-title">
						<h1 class="main-title">Tambah Nilai Alternatif Ara</h1>
						<hr class="title-line">
					</div>
					<!-- akhir header title -->
				</div>
				<div class="card bg-main-card">
					<div class="card-header card-header-custom">
						Form <strong>Tambah Nilai</strong> Alternatif
					</div>
					...
					<div class="card-body">
						<form method="POST" action="" class="form-custom">
							...
							<?php //var_dump($criteria); die; 
							foreach ($criteria->result_array() as $criteria) : ?>
									...
									<div class="form-group row">
										...
										<div class="col-sm-10">
											<select name="nilai_<?= $criteria['kode']; ?>" class="select-custom custom-select">
												...
												<option class="custom-option" value="3">Banyak</option>
												<option class="custom-option" value="2">Sedang</option>
												<option class="custom-option" value="1">Sedikit</option>
											</select>
											<!-- <small>
								...
								<?php elseif ($criteria['kode'] == 'K04') : ?>
									<div class="form-group row">
										...
										<div class="col-sm-10">
											<select name="nilai_<?= $criteria['kode']; ?>" class="select-custom custom-select">
												<option value="" class="custom-option" disabled selected>Pilih nilai..</option>
												<option class="custom-option" value="3">Pupuk kandang</option>
												<option class="custom-option" value="2">Pupuk kompos</option>
												<option class="custom-option" value="1">Pupuk organik</option>
											</select>
											<!-- <small>
											<?php //echo 'nilai_' . $criteria['kode']; 
											?>
								...
								<?php else : ?>
									<div class="form-group row">
										<label class="col-sm-2 col-form-label"><?= $criteria['nama'] ?></label>
										<div class="col-sm-10">
											<input type="text" class="form-control input-custom" name="nilai_<?= $criteria['kode']; ?>" autocomplete="off" value="<?= set_value('nilai_' . $criteria['kode']); ?>">
											<?= form_error('nilai_' . $criteria['kode'], '<small class="text-danger">', '</small>'); ?>
											<!-- <small>
											<?php //echo 'nilai_' . $criteria['kode']; 
											?>
