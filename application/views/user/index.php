		<div class="collapse navbar-collapse" id="navbarNavAltMarkup">
			<div class="navbar-nav ml-auto">
				<a class="nav-item nav-link txt-menu garis-biru-menu" id="nav-home" href="<?= base_url('user'); ?>">beranda</a>
				...
				<div class="carousel-inner">
					<div class="carousel-item" data-interval="20000">
						...
						<div class="carousel-caption d-none d-md-block">
							...
							<a class="btn btn-primary btn-lg" style="font-size: 16px;" href="<?= base_url('user/panduan'); ?>" role="button">Pelajari Lebih Lanjut &nbsp; <i class="far fa-arrow-alt-circle-right"></i></a>
						</div>
					</div>
					<div class="carousel-item" data-interval="20000">
